...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="bg-white md:px-14 p-4 max-w-screen-2xl mx-auto text-primary fixed top-0 right-0 left-0">
        <div className="text-lg container mx-auto flex justify-between items-center font-medium">
          ...
          <div className="space-x-12 hidden md:flex items-center">
            ...
            <button className="bg-secondary py-w px-4 transition-all duration-300 rounded hover:text-white hover:bg-indigo-600">
              Sign up
            </button>
          </div>
      ...
      <div
        className={`sapce-y-4 px-4 pt-24 pb-5 bg-secondary ${
